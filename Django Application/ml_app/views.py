...
def predict_page(request):
    ...
    # 这是你要新加的一行（把下面引号里的内容换成你刚才复制的真实路径）：
        path_to_model = r"C:\Users\86187\Desktop\Deepfake_detection_using_deep_learning-master\Django Application\models\model_84_acc_10_frames_final_data.pt"
        ...
        try:
            ...
            for i in range(len(path_to_videos)):
                ...
                prediction = predict(model, video_dataset[i].cpu(), './', video_file_name_only)
